...
@objc public protocol CameraScannerViewOutputDelegate: class {
...
public final class CameraScannerViewController: UIViewController {
   ...
   @objc public weak var delegate: CameraScannerViewOutputDelegate?
    ...
    private func setupView() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(captureSessionBegan), name: Notification.Name.AVCaptureSessionDidStartRunning, object: nil)
        }
